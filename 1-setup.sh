...
-------------------------------------------------------------------------
"
cat /root/ArchInstall/pkg-files/pacman-pkgs.txt | while read line; do
...
if ! source /root/ArchInstall/setup.conf; then
  ...
  echo "username=${username,,}" >>${HOME}/ArchInstall/setup.conf

  #Set Password
  read -p "Please enter password:" password
  echo "password=${password,,}" >>${HOME}/ArchInstall/setup.conf
  ...
  echo "nameofmachine=${nameofmachine,,}" >>${HOME}/ArchInstall/setup.conf
fi
echo -ne "
-------------------------------------------------------------------------
                    Adding User
